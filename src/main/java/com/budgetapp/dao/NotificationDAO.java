...
public class NotificationDAO implements GenericDAO<Notification> {
    ...
    @Override public Optional<Notification> read(int id) { return Optional.empty(); }
    @Override public boolean update(Notification entity) { return false; }
    @Override public boolean delete(int id) { return false; }
    @Override public List<Notification> getAll() { return new ArrayList<>(); }
}