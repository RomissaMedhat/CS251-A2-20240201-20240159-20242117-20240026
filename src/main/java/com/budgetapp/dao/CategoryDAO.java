...
public class CategoryDAO implements GenericDAO<Category> {
    ...
    public boolean deleteCategory(int categoryId) {
        // Reassign all transactions from this category to default category (Food, id=1)
        new TransactionDAO().reassignCategory(categoryId, 1);
    ...
    @Override public Optional<Category> read(int id) { return Optional.empty(); }
    @Override public boolean update(Category entity) { return false; }
    @Override public boolean delete(int id) { return false; }
    @Override public List<Category> getAll() { return new ArrayList<>(); }
}